...
[在线研究页](https://yydshly.github.io/0919_codex_project/011-frappe-hrms/) · [返回总索引](../) · [上游仓库](https://github.com/frappe/hrms) · [官方文档](https://docs.frappe.io/hr/introduction)
...
- [独立总览图](map.html) 支持适应窗口和原尺寸阅读；[SVG 原图](capability-map.svg) 可下载并放大。

![Frappe HR 业务能力、技术实现与学习价值全景](capability-map.svg)
...
![本项目原创能力演示：总览、待办审批和流程联动](demo-cover.png)
